                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="width:600px;"> <a href="https://google.com" target="_blank">
                                                                                ...
                                                                                <img alt="" height="auto" src="https://res.cloudinary.com/dc0rn8rch/image/upload/v1584968561/header-top-E-Learning_ldyrss.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:600px;"> <a href="https://google.com" target="_blank">
                                                                ...
                                                                <img alt="" height="auto" src="https://res.cloudinary.com/dc0rn8rch/image/upload/v1584969678/header-bottom-E-Learning_vw6bmf.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">
                                                ...
                                                <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family: 'Poppins', sans-serif !important;font-size:20px;font-weight:bold;line-height:24px;text-align:left;color:#212b35;">
                                                                    E-Learning - Verifikasi Akun</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family: 'Poppins', sans-serif !important;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                                                    Sebelum resmi menjadi siswa di website E-Learning,
